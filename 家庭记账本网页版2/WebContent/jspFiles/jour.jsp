...
<script src="../jsFiles/jour.js" charset="gbk"></script>
         ...
         <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="adjust-nav">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand"><i class="fa fa-square-o "></i>&nbsp;游客</a>
                </div>
        ...
        <div class="navbar-default navbar-side"> <!-- nav role="navigation" -->
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-sitemap "></i>游客功能<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                        	<li>
                                <a href="#" onclick="MakePageTo_Apply_Add_Member()">申请用户注册</a>
                            </li>
                            <li>
                                <a href="#" onclick="MakePageTo_Apply_Reset_Password()">申请密码重置</a>
                            </li>
                        </ul>
                    </li>
                    <li>
